...
class _Translations$networkInterfacesPage$ga extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'De réir réamhshocraithe, úsáideann LightingSend na comhéadain líonra go léir atá ar fáil. Is féidir leat líonraí nach dteastaíonn a eisiamh anseo. Ní mór duit an freastalaí a atosú chun na hathruithe a chur i bhfeidhm.';
  @override
...
class _Translations$receiveOptionsPage$ga extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Fillteán LightingSend)';
  @override
...
class _Translations$webSharePage$ga extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Úsáideann LightingSend teastas féinshínithe. Ní mór duit glacadh leis i do bhrabhsálaí.';
  @override
...
class _Translations$aboutPage$ga extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Maidir le LightingSend';
  @override
  List<String> get description => [
    'Is aip foinse oscailte saor in aisce é LightingSend a ligeann duit comhaid agus teachtaireachtaí a roinnt go slán le gléasanna in aice láimhe thar do líonra áitiúil gan nasc idirlín a bheith ag teastáil.',
...
class _Translations$donationPage$ga extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Tá LightingSend saor in aisce, foinse oscailte agus gan aon fhógraí. Más maith leat an aip, is féidir leat tacú leis an bhforbairt le síntiús.';
  @override
...
class _Translations$tray$ga extends Translations$tray$en {
  ...
  @override
  String get close => 'Scoir LightingSend';
  @override
...
class _Translations$settingsTab$general$ga extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Taispeáin LightingSend sa roghchlár comhthéacs';
  @override
...
class _Translations$settingsTab$other$ga extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Tacaigh le LightingSend';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$ga extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Ní féidir le LightingSend gléasanna eile a aimsiú gan cead a bheith aige an líonra áitiúil a scanadh. Deonaigh an cead seo sna socruithe le do thoil.';
  @override
...
class _Translations$dialogs$sendModeHelp$ga extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Is féidir le faighteoirí nach bhfuil LightingSend suiteáilte acu na comhaid roghnaithe a íoslódáil tríd an nasc a oscailt ina mbrabhsálaí.';
}
