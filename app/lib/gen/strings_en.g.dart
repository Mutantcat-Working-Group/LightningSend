...
class Translations$networkInterfacesPage$en {
  ...
  /// en: 'By default, LightingSend uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, LightingSend uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class Translations$receiveOptionsPage$en {
  ...
  /// en: '(LightingSend folder)'
  String get appDirectory => '(LightingSend folder)';
...
class Translations$webSharePage$en {
  ...
  /// en: 'LightingSend uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'LightingSend uses a self-signed certificate. You need to accept it in your browser.';
...
class Translations$aboutPage$en {
  ...
  /// en: 'About LightingSend'
  String get title => 'About LightingSend';

  List<String> get description => [
    'LightingSend is a free, open-source app that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.',
...
class Translations$donationPage$en {
  ...
  /// en: 'LightingSend is free, open-source and without any ads. If you like the app, you can support the development with a donation.'
  String get info => 'LightingSend is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class Translations$tray$en {
  ...
  /// en: 'Quit LightingSend'
  String get close => 'Quit LightingSend';
...
class Translations$settingsTab$general$en {
  ...
  /// en: 'Show LightingSend in context menu'
  String get showInContextMenu => 'Show LightingSend in context menu';
...
class Translations$settingsTab$other$en {
  ...
  /// en: 'Support LightingSend'
  String get support => 'Support LightingSend';
...
class Translations$dialogs$localNetworkUnauthorized$en {
  ...
  /// en: 'LightingSend can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'LightingSend can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class Translations$dialogs$sendModeHelp$en {
  ...
  /// en: 'Recipients who do not have LightingSend installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have LightingSend installed can download the selected files by opening the link in their browser.';
}
