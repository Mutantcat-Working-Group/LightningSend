...
# LightingSend CLI configuration. Command-line flags and environment variables
# (LIGHTINGSEND_ALIAS, LIGHTINGSEND_PORT, LIGHTINGSEND_DESTINATION) take precedence.
