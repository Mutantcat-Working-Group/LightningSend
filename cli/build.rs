fn main() {
    ...
    if std::env::var_os("CARGO_CFG_WINDOWS").is_some() {
        ...
        res.set("ProductName", "LightingSend");
        res.set("FileDescription", "LightingSend CLI");
        res.set("CompanyName", "Tien Do Nam");
        res.set("OriginalFilename", "lightingsend-cli.exe");
        res.set("InternalName", "lightingsend-cli");
